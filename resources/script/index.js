...
let viewArray = [view1, view2, view3];
let vImgArray = [vImage1, vImage2, vImage3];
let imgArray = [img1, img2, img3];
let captionTextArray = [captionText1, captionText2, captionText3];
let closeXArray = [closeX1, closeX2, closeX3];
