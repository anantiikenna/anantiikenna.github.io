...
let vImage7 = document.getElementById('vimage7');
...
let img7 = document.getElementById("img07");
...
let closeX7 = document.getElementsByClassName("close")[6];

// Setting up the Array of each needed element
let viewArray = [view1, view2, view3, view4, view5, view6, view7];
let vImgArray = [vImage1, vImage2, vImage3, vImage4, vImage5, vImage6, vImage7];
let imgArray = [img1, img2, img3, img4, img5, img6, img7];
let captionTextArray = [captionText1, captionText2, captionText3, captionText4, captionText5, captionText6, captionText7];
let closeXArray = [closeX1, closeX2, closeX3, closeX4, closeX5, closeX6, closeX7];
